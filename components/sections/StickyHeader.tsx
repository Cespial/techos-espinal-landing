          ...
          <div className="mx-auto max-w-6xl px-4 py-4">
            ...
            <div className="mt-3 grid grid-cols-2 gap-2">
              <a
                ...
                className="inline-flex min-h-11 items-center justify-center gap-2 rounded-lg bg-[#15803d] px-3 text-xs font-semibold text-white active:scale-[0.98] sm:text-sm"
              >
                <WhatsAppIcon className="h-4 w-4" />
                Pedir cotización
              </a>
